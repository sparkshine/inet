...
// Routing information access
    ...
    virtual int  getRouteGroup(const AddressGroup &gr, std::vector<Address> &){opp_error("getRouteGroup, method is not implemented"); return 0;}
    virtual int  getRouteGroup(const Address&, std::vector<Address> &, Address&, bool &, int group = 0){opp_error("getRouteGroup, method is not implemented"); return 0;}

    virtual bool getNextHopGroup(const AddressGroup &gr, Address &add, int &iface, Address&){opp_error("getNextHopGroup, method is not implemented"); return false;}
    virtual bool getNextHopGroup(const Address&, Address &add, int &iface, Address&, bool &, int group = 0){opp_error("getNextHopGroup, method is not implemented"); return false;}
